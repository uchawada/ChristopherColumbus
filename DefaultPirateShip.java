...
public class DefaultPirateShip implements ShipStrategy, Observer {
	...
	public DefaultPirateShip(OceanMap oceanMapIN, Point currentPirateLocationIN) {
	...
	public String getShipPace() {
		return "Pirate Ship is in default mode.";
	}
